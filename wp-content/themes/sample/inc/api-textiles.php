 ...
 * Usage: http://127.0.1.1/repo-github/wordpress-vue-masonry/wp-json/textiles/v1/lang/en/parent/2/page/1
 * https://developer.wordpress.org/rest-api/extending-the-rest-api/adding-custom-endpoints/
 * https://webdevstudios.com/2015/07/09/creating-simple-json-endpoint-wordpress/
 */
function api_textiles($data) {
    $output = array();
...
add_action('rest_api_init', function () {
    register_rest_route('textiles/v1', '/lang/(?P<lang>[a-zA-Z0-9-]+)/parent/(?P<parent_id>\d+)/page/(?P<page_number>\d+)', array(
        'methods' => 'GET',
        'callback' => 'api_textiles',
    ));
});

/**
 * Custom JSON API endpoint.
 * Usage: http://127.0.0.1/projects/andrew-collections-wordpress/wp-json/textiles/v1/lang/en/category/bird-feeders/page/1
 * https://developer.wordpress.org/rest-api/extending-the-rest-api/adding-custom-endpoints/
 * https://webdevstudios.com/2015/07/09/creating-simple-json-endpoint-wordpress/
 */
function api_textiles_by_category($data) {
    $output = array();
...
add_action('rest_api_init', function () {
    register_rest_route('textiles/v1', '/lang/(?P<lang>[a-zA-Z0-9-]+)/category/(?P<category_slug>[a-zA-Z0-9-]+)/page/(?P<page_number>\d+)', array(
        'methods' => 'GET',
        'callback' => 'api_textiles_by_category',
    ));
});
